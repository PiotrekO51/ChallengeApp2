    ...
    public class EmployeeInFile : EmployeeBase
    {
        ...
        private Statistics CountStatistics(List<float> grades)
        {
            ...
            return statistics;
                    ...
                    //results.Average = 0;
                    //results.Max = float.MinValue;
                    //results.Min = float.MaxValue;
                    //var counter = 0;
                    ...
                    //            if (number >= 0)
                    //            {
                    //                results.Max = Math.Max(results.Max, number);
                    //                results.Min = Math.Min(results.Min, number);
                    //                results.Average += number;
                    //                counter++;
                    //            }
                    //            if (counter > 0)
                    //            {
                    //                results.Average = results.Average / counter;
                    //            }
                    //            else
                    //            {
                    //                results.Max = 0;
                    ...
                    //{
                    //    case var average when average >= 80:
                    //        results.AverageLetther = 'A';
                    //        break;
                    //    case var average when average >= 60:
                    //        results.AverageLetther = 'B';
                    //        break;
                    //    case var average when average >= 40:
                    //        results.AverageLetther = 'C';
                    //        break;
                    //    case var average when average >= 20:
                    //        results.AverageLetther = 'D';
                    //        break;
                    //    default:
                    //        results.AverageLetther = 'E';
                    //        break;
                    //}
